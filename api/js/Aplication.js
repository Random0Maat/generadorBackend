...
Application.prototype._generateStructure = function(b) {
	...
	c.width = this._width;
	c.height = this._height;
	c.onmousedown = function() {/////////////////////clic en el lienzo/////////////////////////////////////modificar aqui
		change=true;
	...
	j.appendChild(h);
	var k = this;
	h.onclick = function() {/////////////////////////////no identificado////////////////////////////
		///alert("onclick1");
...
Application.prototype._addTab = function(b) {
	...
	this._tabs[b] = a;
	var c = this;
	a.onclick = function() {////////////////////////seleccionar pestanha/////////////////////////////////
		//alert("seleccionar pestanha");
		if (c._selected == b) {
...
Application.prototype._getDiagramImage = function() {
	if (this._selected) {
		...
		this._diagrams[this._selected].draw();////////////////////////////////draw/////////
...
Application.prototype._generateGeneralMenu = function() {
	...
	c.onclick = function() {///////////////////clic en en el tool de diagramas hide, show///////////////////////////////////////////
		//alert("onclick3");
	...
	this._addMenuItem(this._tools_ul1, "Export/Import to xml", function(m) {///exportar/importar
		...
		j.onsubmit = function() {//////////////////////exportar xml///////////////////////
			//alert("submit1");
			return false
		};
	...
	this._addMenuItem(this._tools_ul1, "Delete object", function(l, h, p) {
		...
		if (n != null && n instanceof Element) {
			ApplicationValues.dialog.show(function() {
				...
				change=true;////////////////draw///////////////////modificar aqui
			});
	...
	c.onclick = function() {/////////////////////////////////clic en el tool de herramientas de elementos hide, show////////////////////////////////////
		//alert("onclick3");
...
Application.prototype._interactionSingleClick = function(d) {
	...
	var c = this;
	var a = function(g) {
		change=true;////////////////clic con una tarea extra/////////////////aqui actualizar
...
Application.prototype._interactionDoubleClick = function(g) {/////////////////clic con tarea doble/////////////////////
	//alert("ondbclick1");
...
Application.prototype._addMenuItem = function(a, g, f, k, b) {
	...
	switch (k) {
		case 0:
			h.addEventListener("click", function() {///////////////////clic en un elemento///////////////////////////////
				//alert("clic en un elemento");
				if (d._selected) {
		...
		case 1:
			h.addEventListener("click", function() {//////////////////////clic en un elemento///////////////////////////////
				//alert("seleccionste un elemento");
				if (d._selected) {
